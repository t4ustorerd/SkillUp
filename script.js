document.addEventListener("DOMContentLoaded", () => {
    ...
    const translations = {
        en: {
            ...
            'wizard.welcome.ageTitle': 'How old are you?',
            'wizard.welcome.ageDesc': 'This helps us find age-appropriate opportunities.',
            ...
            'wizard.academics.gpaDesc': 'Enter your current GPA or grades.',
            'wizard.academics.gpaPh': 'e.g. 3.8 GPA',
            'wizard.academics.levelTitle': 'School Level',
            'wizard.academics.levelDesc': 'What is your current level of education?',
            ...
            'wizard.academics.fieldTitle': 'Field of Interest',
            'wizard.academics.fieldDesc': 'What subjects or industries are you passionate about?',
            ...
            'businessFinder.step1.q': 'What industry are you in?',
            'businessFinder.step1.desc': 'This helps us narrow down candidates with the right background.',
            ...
            'pricing.tab.student': 'Student',
            'pricing.tab.business': 'Business',
            'pricing.student.basic.title': 'Basic Plan',
            'pricing.student.basic.price': 'Free',
            'pricing.student.basic.f1': 'Profile creation',
            'pricing.student.basic.f2': 'Skills test',
            'pricing.student.basic.f3': 'Apply to jobs',
            'pricing.student.basic.f4': 'Basic recommendations',
            'pricing.student.premium.title': 'Premium Plan',
            'pricing.student.premium.price': '$4.99<span class="period">/mo</span>',
            'pricing.student.premium.f1': 'Priority matching',
            'pricing.student.premium.f2': 'Detailed skills report',
            'pricing.student.premium.f3': 'AI interview practice',
            'pricing.student.premium.f4': 'Optimized profile',
            'pricing.business.basic.title': 'Business Plan',
            'pricing.business.basic.price': '$40<span class="period">/mo</span>',
            'pricing.business.basic.f1': 'Access to student profiles',
            'pricing.business.basic.f2': 'Categorized by skills',
            'pricing.business.basic.f3': 'Unlimited opportunity posting',
        ...
        es: {
            ...
            'wizard.welcome.ageTitle': '¿Cuántos años tienes?',
            'wizard.welcome.ageDesc': 'Esto nos ayuda a encontrar oportunidades apropiadas para tu edad.',
            ...
            'wizard.academics.gpaDesc': 'Ingresa tu promedio o calificaciones actuales.',
            'wizard.academics.gpaPh': 'ej. 3.8 GPA',
            'wizard.academics.levelTitle': 'Nivel Escolar',
            'wizard.academics.levelDesc': '¿Cuál es tu nivel educativo actual?',
            ...
            'wizard.academics.fieldTitle': 'Campo de Interés',
            'wizard.academics.fieldDesc': '¿Qué materias o industrias te apasionan?',
            ...
            // Pricing Modal
            'pricing.title': 'Elige Tu Camino',
            'pricing.tab.student': 'Estudiantes',
            'pricing.tab.business': 'Empresas',
            'pricing.student.basic.title': 'Plan Básico',
            'pricing.student.basic.price': 'Gratis',
            'pricing.student.basic.f1': 'Creación de perfil',
            'pricing.student.basic.f2': 'Test de habilidades',
            'pricing.student.basic.f3': 'Aplicación a vacantes',
            'pricing.student.basic.f4': 'Recomendaciones básicas',
            'pricing.student.premium.title': 'Plan Premium',
            'pricing.student.premium.price': '$4.99<span class="period">/mes</span>',
            'pricing.student.premium.f1': 'Prioridad en matching',
            'pricing.student.premium.f2': 'Reporte detallado de habilidades',
            'pricing.student.premium.f3': 'Prácticas de entrevistas con IA',
            'pricing.student.premium.f4': 'Perfil optimizado',
            'pricing.business.basic.title': 'Plan Empresas',
            'pricing.business.basic.price': '$40<span class="period">/mes</span>',
            'pricing.business.basic.f1': 'Acceso a perfiles de jóvenes',
            'pricing.business.basic.f2': 'Categorizado por habilidades',
            'pricing.business.basic.f3': 'Publicación de vacantes ilimitadas',
    ...
    // 8. Pricing Modal Logic
    const pricingModal = document.getElementById('pricingModal');
    const closePricingModal = document.getElementById('closePricingModal');
    const ctaBtns = document.querySelectorAll('[data-i18n="nav.cta"], [data-i18n="cta.btn"]');

    if (pricingModal && closePricingModal) {
        ctaBtns.forEach(btn => {
            btn.addEventListener('click', (e) => {
                e.preventDefault();
        ...
        // Close when clicking empty overlay
        ...
        tabs.forEach(tab => {
            tab.addEventListener('click', () => {
                ...
                const viewObj = document.getElementById(type === 'student' ? 'pricingStudent' : 'pricingBusiness');
                if (viewObj) {
                    viewObj.classList.add('active');
                }
            });
        });
    }
